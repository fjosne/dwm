...
static const char *fonts[]          = { "Source Code Pro:size=6" };
static const char dmenufont[]       = "Source Code Pro:size=6";
...
static Key keys[] = {
	...
	// { MODKEY,                       XK_space,  setlayout,      {.v = &layouts[++chosenLayout]} },
	...
	{ Mod4Mask,                     XK_plus,   setgaps,        {.i = +1 } },
	{ Mod4Mask|ShiftMask,           XK_plus,   setgaps,        {.i = 0  } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
